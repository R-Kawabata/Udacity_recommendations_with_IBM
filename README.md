...
Udacity Data Science Nanodegree project - Recommendation with IBM
...
### Data
`user-item-interactions.csv`: user interaction file.

`articles_community.csv`: articles description file.
